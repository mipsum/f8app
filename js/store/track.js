...
export default function track (action: Action): void {
  switch (action.type) {
    case 'LOGGED_IN':
      console.log('Login', 1, {source: action.source || ''})
