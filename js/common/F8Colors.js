...
export var actionText = '#3FB4CF'
export var inactiveText = '#9B9B9B'
export var darkText = '#032250'
export var lightText = '#7F91A7'
export var cellBorder = '#EEEEEE'
export var darkBackground = '#183E63'
