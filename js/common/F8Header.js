...
import {
  Image, Platform, StyleSheet, TouchableOpacity, ToolbarAndroid, View
} from 'react-native'

import { Text } from './F8Text'
import { darkText, lightText } from './F8Colors'
...
class F8HeaderIOS extends Component {
  ...
  render() {
    ...
    const titleColor = foreground === 'dark' ? darkText : 'white'
    const itemsColor = foreground === 'dark' ? lightText : 'white'
...
var STATUS_BAR_HEIGHT = 'ios' === Platform.OS ? 20 : 25
var HEADER_HEIGHT = 'ios' === Platform.OS ? 44 + STATUS_BAR_HEIGHT : 56 + STATUS_BAR_HEIGHT
...
const Header = 'ios' === Platform.OS ? F8HeaderIOS : F8HeaderAndroid
