...
import {
  ListView, Dimensions, Platform, StyleSheet, View
} from 'react-native'
...
const LIST_VIEW_PAGE_SIZE = 'android' === Platform.OS ? 20 : 1
...
export default class PureListView extends Component {
  ...
  render () {
    ...
    props.renderRow = this.props.renderRow || this.props.renderEmptyList
