...
import fullStarImg from './img/full-star.png'
import emptyStarImg from './img/empty-star.png'
...
export default function RatingQuestion ({ question, rating, onChange, style }: Props) {
