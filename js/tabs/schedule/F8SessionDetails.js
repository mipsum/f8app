...
import {
  Animated, Image, StyleSheet, ScrollView,
  TouchableOpacity, View, PixelRatio
} from 'react-native'

import Subscribable from 'react-native/Libraries/Components/Subscribable'
...
import sharedImg from './img/share.png'
import addedReactImg from './img/added-react.png'

class F8SessionDetails extends Component {
      ...
      <View style={[styles.container, this.props.style]}>
        <ScrollView
          ...
          <TouchableOpacity
            ...
            <Image source={ sharedImg } />
          </TouchableOpacity>
        </ScrollView>
        <View style={styles.actions}>
          <AddToScheduleButton
            addedImageSource={isReactTalk ? addedReactImg : null}
...
export default connect(select, actions)(F8SessionDetails)
