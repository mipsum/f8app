...
import myF8BackgroundImg from './img/my-f8-background.png'
import noSessionsAddedImg from './img/no-sessions-added.png'
  ...
  render () {
    ...
    return (
      <ListContainer
        ...
        backgroundImage={ myF8BackgroundImg }
